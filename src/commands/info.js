...
const run = async (client, msg, args) => {
    try {
        ...
        let regularInvites = `${member.user.id == msg.author.id ? translate("**Davet Sayıları**", "**You** have") : member.user.toString() + translate("sahip", " has")} **${Object.values(user.invites).reduce((x,y)=>x+y)}** ${translate("davet kodları", "invites")}.\n\n` +
        ...
        let embed = new MessageEmbed()
            ...
            .addField(
                ...
                translate("__En Son Davetlenen Kullanıcı__", "__Last invited members__"),
        ...
        let bonusHistoryButton = new MessageButton()
            ...
            .setStyle("SECONDARY")
            .setLabel(translate("Kullanıcı Bonus İnvite Geçmişi", "View bonus invites history"))
